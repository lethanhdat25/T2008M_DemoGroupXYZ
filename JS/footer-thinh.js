function footer(){
    return"<div class=\"menu1\">\n" +
        ...
        "                <li class=\"col-md-1\"><a href=\"\"><b>Lookbook</b></a></li>\n" +
        "            </div>\n" +
        "        </ul>\n" +
        "        <div class=\"form-bot col-md-12\">\n" +
        "            <form class=\"fr-b1 col-md-7\">\n" +
        "                <input type=\"text\" placeholder=\"Nhập email của bạn...\">\n" +
        "            </form>\n" +
        "            <form class=\"fr-b2 col-md-5\">\n" +
        "                <input type=\"submit\" value=\"Đăng kí\">\n" +
        "            </form>\n" +
        "        </div>\n" +
        "        <br/><br/>\n" +
        "        <div class=\"info\">\n" +
        "            <p>Địa chỉ: 218 Lê Văn Sỹ, P.10, Quận Phú Nhuận  | 183B Nguyễn Đình Chiểu, P5, Quận 3</p>\n" +
        "            <div class=\"icon-info\">\n" +
